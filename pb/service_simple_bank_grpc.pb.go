...
func (c *simpleBankClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*ResponseUser, error) {
...
func (UnimplementedSimpleBankServer) CreateUser(context.Context, *CreateUserRequest) (*ResponseUser, error) {
