...
func (s *Store) execCtx(ctx context.Context, fn func(*Queries) error) error {
...
func (s *Store) TransferCtx(ctx context.Context, arg TransferctxParams) (TransferTxResult, error) {
