...
// Source: github.com/peacewalker122/go-sqlc/db/sqlc (interfaces: Store)
...
// TransferCtx mocks base method.
func (m *MockStore) TransferCtx(arg0 context.Context, arg1 db.TransferctxParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferCtx", arg0, arg1)
	ret0, _ := ret[0].(db.TransferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TransferCtx indicates an expected call of TransferCtx.
func (mr *MockStoreMockRecorder) TransferCtx(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransferCtx", reflect.TypeOf((*MockStore)(nil).TransferCtx), arg0, arg1)
}
